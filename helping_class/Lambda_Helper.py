...
class Lambda_Helper:
    ...
    def __init__(self):
        ...
        self.role_arn = f"arn:aws:iam::{account_id}:role/LambdaRoleLlama3"
    ...
    def deploy_function(self, code_file_names, function_name = "", module_name = "lambda_function"):
        ...
        with zipfile.ZipFile(zip_file_path, 'w') as zip_file:
            for code_file_name in code_file_names:
                zip_file.write(code_file_name, arcname="lambda_function.py")
        ...
        try:
            ...
            print(f"Function created: {json.dumps(response, indent = 4)}")
            self.lambda_arn = response['FunctionArn']
            print("Done")
    ...
    def add_lambda_trigger(self, bucket_name, function_name = ""):
        ...
        try:
            ...
            print("Function Trigger not found")
